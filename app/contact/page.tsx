            ...
            <div>
              ...
              {submitStatus === 'error' && (
                <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="text-red-800 font-medium">Mesaj gönderilirken bir hata oluştu. Lütfen tekrar deneyin.</p>
                  </div>
                </div>
              )}
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold py-3 px-6 rounded-lg hover:from-indigo-700 hover:to-purple-700 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {isSubmitting ? (
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-blue-50 border border-blue-200 p-6 rounded-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-blue-800 mb-1">E-posta</h3>
                      <p className="text-gray-700">info@semacelik.com</p>
                      <p className="text-sm text-gray-600 mt-1">7/24 e-posta desteği</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 border border-green-200 p-6 rounded-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">212 871 97 77</p>
                ...
                <div className="bg-purple-50 border border-purple-200 p-6 rounded-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-purple-800 mb-1">Adres</h3>
                      <p className="text-gray-700">
                        Sümbül Efendi Mh<br />
                        Hacı Kadın Cd. No: 34/A<br />
                ...
                <div className="bg-orange-50 border border-orange-200 p-6 rounded-lg">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-orange-800 mb-1">Çalışma Saatleri</h3>
              ...
              <div className="mt-8">
                ...
                <div className="flex gap-4">
                  ...
                  <a href="#" className="bg-gradient-to-r from-purple-600 to-pink-600 text-white p-3 rounded-full hover:from-purple-700 hover:to-pink-700 transition-colors">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
